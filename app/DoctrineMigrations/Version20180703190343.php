 ...
 */
class Version20180703190343 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE customer (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, street_name VARCHAR(255) NOT NULL, post_code VARCHAR(10) NOT NULL, city VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE invoice_item (id SERIAL NOT NULL, invoice INT NOT NULL, description VARCHAR(255) NOT NULL, amount INT NOT NULL, tax INT NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
